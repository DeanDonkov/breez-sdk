...
static func asSwapInfo(swapInfo: [String: Any?]) throws -> SwapInfo {
    ...
    guard let maxSwapperPayable = swapInfo["maxSwapperPayable"] as? Int64 else {
        ...
        var confirmedAtTimestamp: UInt64?
        if hasNonNilKey(data: swapInfo, key: "confirmedAtTimestamp") {
            guard let confirmedAtTimestampTmp = swapInfo["confirmedAtTimestamp"] as? UInt64 else {
                throw SdkError.Generic(message: errUnexpectedValue(fieldName: "confirmedAtTimestamp"))
            }
            confirmedAtTimestamp = confirmedAtTimestampTmp
        }
    ...
    return SwapInfo(
        ...
        confirmedAtTimestamp: confirmedAtTimestamp)    
}
...
static func  dictionaryOf(swapInfo: SwapInfo) -> [String: Any?] {
    return [
            ...
            "confirmedAtTimestamp": swapInfo.confirmedAtTimestamp == nil ? nil : swapInfo.confirmedAtTimestamp,       
    ]
}
